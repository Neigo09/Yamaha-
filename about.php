    ...
    <section class="navbar">
        ...
        <section class="body">
            <div class="container-fluid">
                <div class="row">
                    <div id="col">
                        <img src="img/webp-1900.webp" alt="">

                            <p>We continuously aim to improve and create exceptional value to surprise and excite you. Learn more about who we are, our operations and activities as well as the products and services we offer. At the heart of everything lies our ambition to provide quality in what we deliver and responsibility towards you, our dealers, society and the environment.</p>
                    </div>
