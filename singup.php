            ...
            <div class="row">
                ...
                <div class="col-xl-10">
                    <div class="htoo">
                        ...
                        <a href="singup.php"><i class="fa-solid fa-up-right-and-down-left-from-center"></i>SIGN UP</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                      <div class="col-xl-12">
                        ...
                        <form method="POST">
                            ...
                            <button type="submit" name="sign">REGISTOR</button>
                          </form>
                          <?php
                            if(isset($_POST['sign'])){
                                $name=$_POST['uname'];
                                ...
                                $sql="INSERT INTO admin(uemail, pass, admin_name) VALUES ('$email','$pass','$name')";
